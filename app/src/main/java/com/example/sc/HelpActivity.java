...
import static com.example.sc.StartUpActivity.h;
...
public class HelpActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    help_tv.setTextSize(TypedValue.COMPLEX_UNIT_SP,16);
    if (density > 3) help_tv.setTextSize(TypedValue.COMPLEX_UNIT_SP,12);
    help_tv.setText(h_s);
